    ...
    <div className="min-h-screen w-full bg-[#fafafa] text-[#1a1a1a] flex flex-col items-center justify-center p-6 font-sans antialiased">
      <header className="mb-16 text-center relative w-full max-w-2xl">
        ...
        <div className="absolute -top-12 left-0 md:left-0">
          <a 
            href={lpUrl}
            className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#6b8e4e] hover:opacity-70 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-3xl">
        {apps.map((app) => (
          <button
            ...
            className={`
              ${app.color}
              group relative flex flex-col items-center justify-center p-10 rounded-[2.5rem] 
          ...
          >
            ...
            <div className="text-center">
              <span className="text-2xl font-black block mb-2 tracking-tighter text-[#6b8e4e]">
                {app.name}
              </span>
              <span className="text-gray-400 text-sm font-medium block mb-8">
                {app.desc}
              </span>
      ...
      <footer className="mt-20 text-center">
        ...
        <p className="text-[10px] text-gray-300 font-bold uppercase tracking-[0.3em] mt-2">
          &copy; 2026 Voca-nical studio.
        </p>
      </footer>
    </div>
  );
